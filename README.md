...
2. 「#」が付くのは1個から5個まで。  
3. 「♭」が付くのは1個から6個まで。  
4. 調号がつかない場合（Cメジャー）と合わせて、全部で12通り。（１オクターブ内の音の総数）  
5. 「#」と「♭」が混在することはない。（他のスケールでは、混在するものもある。）  
6. 「#」が１個だけ付くのは、Gメジャーで、「#」は「F」に付く。
7. Gメジャーで、キーの「G」と、「#」が付く「F」が、鍵盤のどこにあるかを確認し、すぐにイメージできるようにする。  
8. 「#」が0個から増えるにしたがって、メジャーキーは順に「C、G、D、A、E、B」となる。  
9. メジャーキーは、「#」が0個、2個、4個なら「C、D、E」で、1個、3個、5個なら「G、A、B」である。  
10. 「C、G、D、A、E、B」は、ピアノの鍵盤でいえば、「黒鍵２個側」「黒鍵３個側」の白鍵に交互に昇順に現れている。これをすぐにイメージできるようにする。  
11. 「#」が付くのは、順に「F、C、G、D、A」で、「黒鍵３個側」「黒鍵２個側」に交互に昇順に現れている。  
