...
（注：メジャースケール、マイナースケール以外の、以下の記述が当てはまらないスケールもあると分かりましたが、荷が重いので割愛します。）

## 0.覚えることと、あとは脳内で暗算する。
1. メジャースケールで考える。マイナースケールは覚えずに、「平行調はキーが短三度下」から暗算する。「短三度」は「ひとつ飛ばしの白鍵同士の間に黒鍵が１個しかない場合」であることや、「指板の６弦５フレットAと６弦８フレットCの距離」であることをイメージを覚える。
2. 「#」が１個だけ付くのは、「移動ド」を「G」にしたとき。「移動シ」の「F」に「#」が付く。「鍵盤で移動ドをGで弾く」イメージを覚える。
3. 「♭」が１個だけ付くのは、「移動ド」を「F」にしたとき。「移動ファ」の「B」に「♭」が付く。「鍵盤で移動ドをFで弾く」イメージを覚える。
4. 「#」が増えるにしたがって、キーは「G、D、A、E、B」、「#」が付く位置は「F、C、G、D、A」と現れる。鍵盤でこの出現順を覚える。
5. 「♭」が増えるにしたがって、キーは「F、B♭、E♭、A♭、D♭、G♭」、「♭」が付く位置は「B、E、A、D、G、C」と現れる。鍵盤でこの出現順を覚える。
6. 鍵盤で実際に、１２通りのキーで移動ドのドレミファソラシドを弾いて、上記を確認する。

## 1.覚え方（なぜそうなるかは「2.」以降）
1. まず、「メジャースケール」（ドレミファソラシド）で考えます。
2. 「#」が付くパターンは1個から5個まで。  
3. 「♭」が付くパターンは1個から6個まで。  
4. 調号がつかない場合（Cメジャー）は、「#」にグルーピングして考え、全部で12通り。（１オクターブ内の音の総数）  
5. 「#」と「♭」が混在することはない。（メジャー、まいなー以外では、混在するスケールもある。）  
6. 「#」が１個だけ付くのは、Gメジャーで、その場合「#」は「F」に付く。
7. Gメジャーで、キーの「G」と、「#」が付く「F」が、鍵盤のどこにあるかを確認し、すぐにイメージできるようにする。  
8. 「#」が0個から1個増えるにしたがって、メジャーキーは順に「C、G、D、A、E、B」となる。  
9. メジャーキーは、「#」が0個、2個、4個なら「C、D、E」で、1個、3個、5個なら「G、A、B」である。  
10. 「C、G、D、A、E、B」は、ピアノの鍵盤でいえば、「黒鍵２個側」「黒鍵３個側」の白鍵に交互に昇順に現れている。この出現順を、すぐにイメージできるようにするのがキモ。  
11. 「#」が付く位置は、順に「F、C、G、D、A」で、「黒鍵３個側」「黒鍵２個側」に交互に昇順に現れている。最初が「F」、次が「C」、その次が「G」、というこの出現順を、すぐにイメージできるようにするのがキモ。  
12. 「♭」が１個だけ付くのは、Fメジャーで、「♭」は「B」に付く。
13. Fメジャーで、キーの「F」と、「♭」が付く「B」が、鍵盤のどこにあるかを確認し、すぐにイメージできるようにする。  
14. 「♭」が1個から増えるにしたがって、メジャーキーは順に「F、B♭、E♭、A♭、D♭、G♭」となる。  
15. メジャーキーは、「♭」が3個、5個なら「E♭、D♭」で、1個、2個、4個、6個なら「F、B♭、A♭、G♭」である。
16. Fのあと、「B♭、E♭、A♭、D♭、G♭」は、ピアノの鍵盤でいえば、「黒鍵３個側」「黒鍵２個側」に交互に降順に現れている。 
17. 「♭」が付くのは、順に「B、E、A、D、G、C」で、「黒鍵３個側」「黒鍵２個側」に交互に昇順に現れている。   
18. 「#」や「♭」が増えていくとき、「それまでに調号がついた音」にさらに上乗せで調号がつく音が増えていき、調号がつく音の入れ替わりはない。  
  - 「#」が付く音：「F」→「F」+「C」→「FC」+「G」→「FCG」+「D」→「FCGD」+「A」  
  - 「♭」が付く音：「B」→「B」+「E」→「BE」+「A」→「BEA」+「D」→「BEAD」+「G」→「BEADG」+「C」  
19. 「平行調」は、構成音が同一であるメジャースケールとマイナースケールのペアのことだが、キー同士は「短３度」である。ピアノの鍵盤でいえば、「白鍵を、ひとつ飛ばしで２つ押さえた時に、間に黒鍵が１個だけある場合」の間隔である。  
20. 平行調でどちらにも調号がつかないのは、具体的には「Am -> C」、「Bm -> D」、「Dm -> F」、「Em -> G」の４通り。鍵盤のどこにあるかをイメージする。
21. 「平行調のどちらかに調号が付く場合」は、暗記せず、「メジャーキーの短３度下がマイナーキー」から、導けばよい。  
